...
@Controller("companyExperienceAction")
@Scope("prototype")
public class CompanyExperienceAction extends BaseAction<CompanyExperience> implements CommonAction {
	@Resource
	private CompanyExperienceService companyExperienceService;
