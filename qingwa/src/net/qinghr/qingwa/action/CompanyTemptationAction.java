...
@Controller("companyTemptationAction")
@Scope("prototype")
public class CompanyTemptationAction extends BaseAction<CompanyTemptation>
		implements CommonAction {
	@Resource
	private CompanyTemptationService companyTemptationService;
