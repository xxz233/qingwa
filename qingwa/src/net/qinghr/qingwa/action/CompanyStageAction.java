...
@Controller("companyStageAction")
@Scope("prototype")
public class CompanyStageAction extends BaseAction<CompanyStage> implements
		CommonAction {
	@Resource
	private CompanyStageService companyStageService;
