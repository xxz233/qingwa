...
@Controller("companyFoundTeamAction")
@Scope("prototype")
public class CompanyFoundTeamAction extends BaseAction<CompanyFoundTeam> implements
		CommonAction {
	@Resource
	private CompanyFoundTeamService companyFoundTeamService;
