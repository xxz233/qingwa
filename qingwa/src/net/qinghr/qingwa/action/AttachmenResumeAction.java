...
@Controller("attachmenResumeAction")
@Scope("prototype")
public class AttachmenResumeAction extends BaseAction<AttachmenResume>
		implements CommonAction {
	@Resource
	private AttachmenResumeService attachmenResumeService;
	@Override
