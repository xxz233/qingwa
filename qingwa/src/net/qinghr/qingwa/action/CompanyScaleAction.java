...
import net.qinghr.qingwa.service.CompanyScaleService;
import net.qinghr.qingwa.vo.CompanyScale;
@Controller("companyScaleAction")
@Scope("prototype")
public class CompanyScaleAction extends BaseAction<CompanyScale> implements
		CommonAction {
	@Resource
