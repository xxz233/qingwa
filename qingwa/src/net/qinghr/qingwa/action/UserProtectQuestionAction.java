...
@Controller("userProtectQuestionAction")
@Scope("prototype")
public class UserProtectQuestionAction extends BaseAction<UserProtectQuestion>
		implements CommonAction {
	@Resource
	private UserProtectQuestionService userProtectQuestionService;
