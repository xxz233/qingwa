...
import net.qinghr.qingwa.service.JobSubscriberService;
import net.qinghr.qingwa.util.Pager;
import net.qinghr.qingwa.vo.JobSubscriber;
@Transactional
@Service("jobSubscriberService")
public class JobSubscriberServiceImpl implements JobSubscriberService {
	@Resource
