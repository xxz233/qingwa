...
public class EmailUtil {  
    ...
    public static void sendMessage(String smtpHost, String from,  
            String licenseCode, String to, String subject,  
        ...
        Session mailSession = Session.getInstance(props,new MyAuthenticator(from,licenseCode));  
        ...
        transport.connect(smtpHost,licenseCode);  
