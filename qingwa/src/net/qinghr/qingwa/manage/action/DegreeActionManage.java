...
@Controller("digreeActionManage")
@Scope("prototype")
public class DegreeActionManage extends BaseAction<Degree> implements CommonAction {
	@Resource
	private DegreeServiceManage digreeServiceManage;
