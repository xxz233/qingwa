...
@Controller("configActionManage")
@Scope("prototype")
public class ConfigActionManage extends BaseAction<Config> implements CommonAction {
	@Resource
	private ConfigServiceManage configServiceManage;
