...
@Controller("personalSalaryActionManage")
@Scope("prototype")
public class PersonalSalaryActionManage extends BaseAction<PersonalSalary> implements
		CommonAction {
	@Resource
	private PersonalSalaryServiceManage personalSalaryServiceManage;
