...
@Controller("jobCollectionActionManage")
@Scope("prototype")
public class JobCollectionActionManage extends BaseAction<JobCollection> implements
		CommonAction {
	@Resource
	private JobCollectionServiceManage jobCollectionServiceManage;
