...
@Controller("adminLogActionManage")
@Scope("prototype")
public class AdminLogActionManage extends BaseAction<AdminLog> implements
		CommonAction {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2759302395394298990L;
	@Resource
	private AdminLogServiceManage adminLogServiceManage;
