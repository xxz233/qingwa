...
@Controller("jobSubscriberActionManage")
@Scope("prototype")
public class JobSubscriberActionManage extends BaseAction<JobSubscriber> implements
		CommonAction {
	@Resource
	private JobSubscriberServiceManage jobSubscriberServiceManage;
