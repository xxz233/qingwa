...
@Controller("companyPicActionManage")
@Scope("prototype")
public class CompanyPicActionManage extends BaseAction<CompanyPic> implements
		CommonAction {
	@Resource
	private CompanyPicServiceManage companyPicServiceManage;
