...
@Controller("jobTypeActionManage")
@Scope("prototype")
public class JobTypeActionManage extends BaseAction<JobType> implements CommonAction {
	@Resource
	private JobTypeServiceManage jobTypeServiceManage;
