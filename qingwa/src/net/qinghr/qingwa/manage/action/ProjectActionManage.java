...
@Controller("projectActionManage")
@Scope("prototype")
public class ProjectActionManage extends BaseAction<Project> implements CommonAction {
	@Resource
	private ProjectServiceManage projectServiceManage;
