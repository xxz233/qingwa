...
@Controller("companyStageActionManage")
@Scope("prototype")
public class CompanyStageActionManage extends BaseAction<CompanyStage> implements
		CommonAction {
	@Resource
	private CompanyStageServiceManage companyStageServiceManage;
