...
@Controller("educationalBackgroundActionManage")
@Scope("prototype")
public class EducationalBackgroundActionManage extends
		BaseAction<EducationalBackground> implements CommonAction {
	@Resource
	private EducationalBackgroundServiceManage educationalBackgroundServiceManage;
