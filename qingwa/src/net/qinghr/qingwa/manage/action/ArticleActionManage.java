...
@Controller("articleActionManage")
@Scope("prototype")
public class ArticleActionManage extends BaseAction<Article> implements CommonAction {
	@Resource
	private ArticleServiceManage articleServiceManage;
