...
@Controller("resumeActionManage")
@Scope("prototype")
public class ResumeActionManage extends BaseAction<Resume> implements CommonAction {
	@Resource
	private ResumeServiceManage resumeServiceManage;
