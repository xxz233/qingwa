...
@Controller("userProtectQuestionActionManage")
@Scope("prototype")
public class UserProtectQuestionActionManage extends BaseAction<UserProtectQuestion>
		implements CommonAction {
	@Resource
	private UserProtectQuestionServiceManage userProtectQuestionServiceManage;
