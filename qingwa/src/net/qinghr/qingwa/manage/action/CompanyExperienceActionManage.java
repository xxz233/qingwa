...
@Controller("companyExperienceActionManage")
@Scope("prototype")
public class CompanyExperienceActionManage extends BaseAction<CompanyExperience> implements CommonAction {
	@Resource
	private CompanyExperienceServiceManage companyExperienceServiceManage;
