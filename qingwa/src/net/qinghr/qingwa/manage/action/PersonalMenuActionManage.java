...
@Controller("personalMenuActionManage")
@Scope("prototype")
public class PersonalMenuActionManage extends BaseAction<PersonalMenu> implements
		CommonAction {
	@Resource
	private PersonalMenuServiceManage personalMenuServiceManage;
