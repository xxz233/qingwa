...
@Controller("companyPreparedLabelActionManage")
@Scope("prototype")
public class CompanyPreparedLabelActionManage extends
		BaseAction<CompanyPreparedLabel> implements CommonAction {
	@Resource
	private CompanyPreparedLabelServiceManage companyPreparedLabelServiceManage;
