...
@Controller("resumeJobActionManage")
@Scope("prototype")
public class ResumeJobActionManage extends BaseAction<ResumeJob> implements
		CommonAction {
	@Resource
	private ResumeJobServiceManage resumeJobServiceManage;
