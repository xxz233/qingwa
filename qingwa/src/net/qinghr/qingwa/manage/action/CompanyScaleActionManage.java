...
@Controller("companyScaleActionManage")
@Scope("prototype")
public class CompanyScaleActionManage extends BaseAction<CompanyScale> implements
		CommonAction {
	@Resource
	private CompanyScaleServiceManage companyScaleServiceManage;
