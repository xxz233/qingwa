...
@Controller("companyJobNatureActionManage")
@Scope("prototype")
public class CompanyJobNatureActionManage extends BaseAction<CompanyJobNature> implements CommonAction {
	@Resource
	private CompanyJobNatureServiceManage companyJobNatureServiceManage;
