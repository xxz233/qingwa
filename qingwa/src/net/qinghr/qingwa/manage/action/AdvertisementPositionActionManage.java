...
@Controller("advertisementPositionActionManage")
@Scope("prototype")
public class AdvertisementPositionActionManage extends
		BaseAction<AdvertisementPosition> implements CommonAction {
	@Resource
	private AdvertisementPositionServiceManage advertisementPositionServiceManage;
