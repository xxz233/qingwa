...
@Controller("resumeStatusActionManage")
@Scope("prototype")
public class ResumeStatusActionManage extends BaseAction<ResumeStatus> implements
		CommonAction {
	@Resource
	private ResumeStatusServiceManage resumeStatusServiceManage;
