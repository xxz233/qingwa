...
@Controller("companyTemptationActionManage")
@Scope("prototype")
public class CompanyTemptationActionManage extends BaseAction<CompanyTemptation>
		implements CommonAction {
	@Resource
	private CompanyTemptationServiceManage companyTemptationServiceManage;
