...
@Controller("companyProductActionManage")
@Scope("prototype")
public class CompanyProductActionManage extends BaseAction<CompanyProduct> implements
		CommonAction {
	@Resource
	private CompanyProductServiceManage companyProductServiceManage;
