...
@Controller("resultActionManage")
@Scope("prototype")
public class ResultActionManage extends BaseAction<Result> implements CommonAction {
	@Resource
	private ResultServiceManage resultServiceManage;
