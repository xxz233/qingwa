...
public class ArticleTypeDAOImpl implements ArticleTypeDAO{
	...
	public ArticleType findById(java.lang.Integer id) {
		...
		try {
			ArticleType instance = (ArticleType) getCurrentSession().get(
					"net.qinghr.qingwa.vo.Articletype", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(ArticleType instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("net.qinghr.qingwa.vo.Articletype")
	...
	public ArticleType merge(ArticleType detachedInstance) {
		...
		try {
			ArticleType result = (ArticleType) getCurrentSession().merge(
					detachedInstance);
	...
	public static ArticleTypeDAOImpl getFromApplicationContext(
			ApplicationContext ctx) {
		return (ArticleTypeDAOImpl) ctx.getBean("ArticletypeDAO");
	}
