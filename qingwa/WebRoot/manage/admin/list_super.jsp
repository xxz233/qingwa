  ...
  <body>
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="<%=basePath %>manage/index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理员</span><span class="crumb-step">&gt;</span><span class="crumb-name">超级管理员</span></div>
        </div>
  	...
  	function getContent(flag,account,enable,startDate,endDate){
  		if(account==''){
	  		...
	  		$.post(
	  			...
	  			{'isSuper':'true','flag':flag,'enable':enable,'startDate':startDate,'endDate':endDate},
	  			function(e){
	  				var content = $('#content');
	  				var c = $(e);
	  				content.empty();
	  		...
	  		$.post(
	  			'<%=basePath%>manage/admin/content.jsp',
	  			{'isSuper':'true','flag':flag,'account':account,'enable':enable,'startDate':startDate,'endDate':endDate},
	  			function(e){
	  				var content = $('#content');
	  				var c = $(e);
	  				content.empty();
