  //修改简历名称，重命名监听
    ...
    $("#basicInfo .c_edit").bind("click", function() {	
    	var a = $("#nameVal").val(),
            b = $("#genderVal").val(),
            c = $("#topDegreeVal").val(),
            cId = $("#topDegreeVal").attr("name"),
            d = $("#workyearVal").val(),
            dId = $("#workyearVal").attr("name"),
            e = $("#currentStateVal").val(),
            eId = $("#currentStateVal").attr("name"),
            f = $("#emailVal").val(),
            g = $("#telVal").val();
        	$("#username").val(a),
        	...
        	$("#workyear").val(dId), 
        	$("#select_workyear").val(d).css("color", "#333"), "" != e && ($("#currentState").val(eId), 
        	$("#select_currentState").val(e).css("color", "#333")), 
        	$("#email").val(f), 
        	$("#tel").val(g), 
        	$("#portraitShow img").attr("src", 
        	$("#basicInfo .basicShow img").attr("src")),
        	$("#portraitNo").hide(), 
       		$("#portraitShow").show(), 
       		$(this).addClass("dn"), 
       		$("#basicInfo .basicShow").addClass("dn"), 
       		$("#basicInfo .basicEdit").removeClass("dn"), j($("#basicInfo"))
    });
    //验证基本信息
    ...
    $("#box_workyear").on("click", "ul li", function(a) {
        a.stopPropagation();
        var b = $(this).text();
        var personalExperienceId = $(this).attr("id").substr(18);
        $("#select_workyear").val(b).css("color", "#333").removeClass("select_focus"), 
        $("#workyear").val(personalExperienceId), 
        $("#box_workyear").hide(), 
...
//    });
    ...
    $("#box_expectSalary").on("click", "ul li", function(a) {
        ...
        $("#expectSalary").val(b),
        $("#expectSalary").attr("min",min),
        $("#expectSalary").attr("max",max),
        $("#box_expectSalary").hide(),
    ...
    b = {
            ...
            Edit: function() {
                ...
                $("#select_expectCity").val("期望城市，如：北京").css("color", "#999")) : ($("#expectCity").val($("#expectCityVal").attr("name").substring(4)), 
                ...
                $("#select_expectSalary").val("期望月薪").css("color", "#999")) : ($("#expectSalary").val(this.expectSalaryVal).attr("min",$("#expectSalaryVal").attr("min")).attr("max",$("#expectSalaryVal").attr("max")), 
                $("#select_expectSalary").val(this.expectSalaryVal).css("color", "#333")), 
                placeholderFn(), this.obj.find(".expectAdd").addClass("dn"), this.obj.find(".expectShow").addClass("dn"), this.obj.find(".c_edit").addClass("dn"), this.obj.find(".expectEdit").removeClass("dn"), 
                j(this.obj)
            },
     Cancel: function() {
            this.expectCityVal || this.typeVal || this.expectSalaryVal ? this.obj.find(".expectEdit").addClass("dn").siblings(".expectShow").removeClass("dn").siblings(".c_edit").removeClass("dn").siblings(".expectAdd").addClass("dn") : this.obj.find(".expectEdit").addClass("dn").siblings(".expectShow").addClass("dn").siblings(".c_edit").addClass("dn").siblings(".expectAdd").removeClass("dn"), k(this.obj)
        }
    }; 
    //点击进入编辑模式
...
//        通过验证后运行
        submitHandler: function(a) {
            ...
            $(a).find(":submit").attr("disabled", !0), $.ajax({
                ...
                if (b.success) {
                    ...
                    $("#lastChangedTime span").text(b.content.refreshTime), k($("#resume_name"))
                } else alert(b.msg);
    ...
    $("#basicInfo .c_edit").bind("click", function() {	
    	var a = $("#nameVal").val(),
            b = $("#genderVal").val(),
            c = $("#topDegreeVal").attr("name"),
            cId = $("#topDegreeVal").val(),
            d = $("#workyearVal").val(),
            dId = $("#workyearVal").attr("name"),
            e = $("#currentStateVal").val(),
            eId = $("#currentStateVal").attr("name"),
        	...
        	$('#basicInfo .profile_radio li input[value="' + b + '"]').attr("checked", !0).parent("li").addClass("current").siblings("li").removeClass("current"),
        	$("#topDegree").val(c), 
        	$("#select_topDegree").val(cId).css("color", "#333"), $("#workyear").val(dId), 
        	$("#select_workyear").val(d).css("color", "#333"), "" != e && ($("#currentState").val(eId), 
        	$("#select_currentState").val(e).css("color", "#333")), $("#email").val(f), $("#tel").val(g), 
        	$("#portraitShow img").attr("src", 
        	$("#basicInfo .basicShow img").attr("src")),
        	$("#portraitNo").hide(), 
       		$("#portraitShow").show(), $(this).addClass("dn"), 
       		$("#basicInfo .basicShow").addClass("dn"), 
       		$("#basicInfo .basicEdit").removeClass("dn"), j($("#basicInfo"))
    }),
    $("#select_topDegree").bind("click", function(a) {
     ...
     $("#select_workyear").bind("click", function(a) {
        ...
        $("#select_topDegree").removeClass("select_focus"),
        $("#select_currentState").removeClass("select_focus"),
        $("#box_workyear").show(), $("#box_topDegree").hide(), 
        $("#box_currentState").hide()
    }), 
    $("#box_workyear").on("click", "ul li", function(a) {
        a.stopPropagation();
     ...
     $("#select_currentState").bind("click", function(a) {
        ...
        $("#select_topDegree").removeClass("select_focus"),
        $("#select_workyear").removeClass("select_focus"),
        $("#box_workyear").hide(), $("#box_topDegree").hide(), 
        $("#box_currentState").show()
    }), 
    $("#box_currentState").on("click", "ul li", function(a) {
        a.stopPropagation();
    ...
    $("#profileForm").validate({
        ...
        submitHandler: function(a) {
            ...
            $.ajax({
                ...
                $("#resubmitToken").val(b.resubmitToken), b.success ? "/resume/myresume.html" == b.content.url ? window.location.href = ctx + b.content.url : (c = b.content.resume, d = c.workYear, "应届毕业生" != d ? (d += "工作经验", $("#workExperience h2 span").text("（投递简历时必填）")) : $("#workExperience h2 span").text(""), e = c.name, "" != c.sex && (e += " | " + c.sex), "" != c.highestEducation && (e += " | " + c.highestEducation), e += " | " + d + "<br />" + c.phone + " | " + c.email + "<br />" + c.status, $(".collapsible_menu dt").html(c.name + "<i></i>"), $("#basicInfo .basicShow span").html(e).parent().removeClass("dn"), $("#basicInfo .basicEdit").addClass("dn"), $("#basicInfo .c_edit").removeClass("dn"), $("#nameVal").val(c.name),
                 ...
                 $("#telVal").val(c.phone), 
                 $("#lastChangedTime span").text(b.content.refreshTime), b.content.isNew && changeAllIds(b.content.jsonIds), scoreChange(b.content.infoCompleteStatus.score), k($("#basicInfo"))) : alert(b.msg), 
     ...
     $("#profileForm .btn_profile_cancel").bind("click", function() {
        $(this).parents(".basicEdit").addClass("dn").siblings(".basicShow").removeClass("dn"),
        $("#basicInfo .c_edit").removeClass("dn"), k($("#basicInfo"))
    }), 
    $("#select_expectCity").bind("click", function(a) {
        a.stopPropagation(), 
        $(this).addClass("select_focus"), 
    ...
    $("#box_expectSalary").on("click", "ul li", function(a) {
        ...
        Edit: function() {
            ...
            $("#select_expectCity").val(this.expectCityVal).css("color", "#333")), "" != this.typeVal ? $('#expectJob .profile_radio li input[value="' + this.typeVal + '"]').attr("checked", !0).parent("li").addClass("current").siblings("li").removeClass("current") : $("#expectJob .profile_radio li input").attr("checked", !1).parent("li").removeClass("current"), 
            $("#expectPosition").val(this.expectPositionVal), "" == this.expectSalaryVal ? ($("#expectSalary").val(""), 
            $("#select_expectSalary").val("期望月薪").css("color", "#999")) : ($("#expectSalary").val(this.expectSalaryVal), 
            $("#select_expectSalary").val(this.expectSalaryVal).css("color", "#333")), placeholderFn(), this.obj.find(".expectAdd").addClass("dn"), this.obj.find(".expectShow").addClass("dn"), this.obj.find(".c_edit").addClass("dn"), this.obj.find(".expectEdit").removeClass("dn"), 
            j(this.obj)
        },
        Cancel: function() {
