  ...
  <div id="body"> 
   ...
   <div id="container"> 
    <div style="" id="stepTip"> 
     <a></a> 
     <img width="803" height="59" src="<%=basePath %>images/tiponce.jpg" /> 
    </div> 
     ...
     <dl class="c_section c_section_mid"> 
      ...
      <dd> 
       <form id="stepForm"> 
        ...
        <img width="668" height="56" class="c_steps" alt="第一步" src="<%=basePath %>images/step1.png" /> 
        ...
        <ul id="stagesList" class="reset"> 
         <li> <input type="hidden" class="select_invest_hidden" name="select_invest_hidden" /> <input type="button" value="请选择发展阶段" class="select_short select_invest" /> 
          ...
          </div> <input type="text" placeholder="请输入投资机构，如真格基金，创新工场" name="stageorg" /> </li> 
        </ul> 
      ...
      <object width="650" height="470" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="FlashID"> <param value="../../flash/avatar.swf?url=http://www.lagou.com/cd/saveProfileLogo.json" name="movie"></param> <param value="high" name="quality"></param> <param value="opaque" name="wmode"></param> <param value="111.0.0.0" name="swfversion"></param> 
       ...
       <!--[if !IE]>--> <object width="650" height="470" data="../../flash/avatar.swf?url=http://www.lagou.com/cd/saveProfileLogo.json" type="application/x-shockwave-flash"> 
        ...
        <div> 
         ...
         <p><a href="http://www.adobe.com/go/getflashplayer"><img width="112" height="33" src="<%=basePath %>images/get_flash_player.gif" alt="获取 Adobe Flash Player" /></a></p> 
        </div> 
        <!--[if !IE]>--> </object> 
       <!--<![endif]--> </object> 
     </div>
    ...
    <!-- end -----------------------------------------> 
    <script src="<%=basePath %>js/step1.min.js" type="text/javascript"></script> 
    <script>
var avatar = {};
