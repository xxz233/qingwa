...
<jsp:include page="/web/inc/menu.jsp"><jsp:param value="my_company" name="curr"/></jsp:include>
<html>
 <body>
  <div id="container"> 
<script src="<%=basePath %>js/swfobject_modified.js" type="text/javascript"></script>
   <div class="clearfix"> 
    <div class="content_l"> 
     <div class="c_detail"> 
      <div style="background-color:#fff;" class="c_logo"> 
       <a title="上传公司LOGO" id="logoShow" class="inline cboxElement" href="#logoUploader"> <img width="190" height="190" alt="公司logo" src="<%=basePath %>images/logo_default.png" /> <span>更换公司图片<br />190px*190px 小于5M</span> </a> 
      </div> 
         <div class="c_logo" style="background-color:#fff;">
   			<div id="logoShow">
   			<img src="<%=basePath %>images/logo_default.png" width="190" height="190" alt="公司logo" />
      ...
      <div id="c_tags_show" class="c_tags solveWrap"> 
       <table> 
        <tbody>
         ...
         <tr> 
          <td>主页</td> 
          <td> <a rel="nofollow" title="http://www.weimob.com" target="_blank" href="http://www.weimob.com">http://www.weim...</a> </td> 
         </tr> 
        </tbody>
       </table> 
        ...
        <table> 
         <tbody>
          ...
          <tr> 
           <td>领域</td>
           <!-- 支持多选 --> 
           <td> <input type="hidden" value="移动互联网" id="industryField" name="industryField" /> <input type="button" style="background:none;cursor:default;border:none !important;" disable="disable" value="移动互联网" id="select_ind" class="select_tags" /> 
          ...
          <tr> 
           <td>规模</td> 
           <td> <input type="hidden" value="150-500人" id="companySize" name="companySize" /> <input type="button" value="150-500人" id="select_sca" class="select_tags" /> 
          ...
          <tr> 
           <td>主页</td> 
           <td> <input type="text" placeholder="请输入网址" value="http://www.weimob.com" name="companyUrl" id="companyUrl" /> </td> 
          </tr> 
         </tbody>
        </table> 
     ...
     <div id="Reported"> 
      ...
      <dl class="c_section c_reported"> 
       ...
       <dd> 
        <!-- 编辑报道 --> 
        <ul class="reset">
         <li> <a style="" class="article" title="随便写" target="_blank" href="http://www.baidu.com">随便写</a> <a title="编辑报道" class="c_edit dn" href="javascript:;" style="display: inline;"></a> 
   ...
   <!-- end -----------------------------------------> 
   <script src="<%=basePath %>js/company.min.js" type="text/javascript"></script> 
   <script>
var avatar = {};
